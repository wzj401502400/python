...
to snake case or rename the existing variable.
"""
...
# function to rename the existing variable
def choice_4():

    # reinput the variable until the program gets the existing variable
    while True:
        print("Pick a variable:")
        var = input()
        if var not in variable:
    ...
    # reinput the new variable name until the program gets the non-repeating variable
    while True:
        print("Pick a new variable name:")
        new_var = input()
        if new_var in variable:
            print("This is already a variable name.")
            continue
        break

    # update the new variable in the variable set and program list
    variable.remove(var)
    variable.add(new_var)
    add_to_program(var, new_var)
