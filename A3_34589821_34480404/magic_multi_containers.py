"""
This program reads items and containers from five csv files, 
...
class MultiContainer(Container):
    ...
    def display(self, space) -> None:
        ...
        # iterate each container of the compartment
        for container in self.compartment:
...
class MagicMultiContainer(MagicContainer):
    ...
    def add_item_flag(self, item) -> bool:
        ...
        for multi_container in self.compartment:
            if multi_container.add_item_flag(item):
                return True
    ...
    def display(self, space) -> None:
        ...
        space += "   "
        for multi_container in self.compartment:
            for container in multi_container.compartment:
                container.display(space)
...
containers += read_multi_containers()
containers += read_magic_containers()
containers += read_magic_multi_containers()
