"""
This program reads items and containers from four csv files, 
allows the user to pick a single container or multi containers or magic containers to loot items 
and list the looted items.
"""
...
class MagicContainer(Container):
    """
    A representation of a MagicContainer that can hold multiple containers.
    """
    ...
    def __init__(self, name, compartment):
        ...
        Parameters:
            ...
            weight_capacity (int or str): The maximum weight capacity of the container.
            total_weight (int or str): The total weight of the container.
            current_weight(int): The current weight of the container.
        """
        super().__init__(name, 0, 0)
    ...
    def __str__(self) -> str:
        ...
        """
        return f"{self.name} (total weight: {self.total_weight}, empty weight: {self.empty_weight}, capacity: {self.current_weight}/{self.weight_capacity})"
    ...
    def add_item_flag(self, item) -> bool:
        ...
        for container in self.compartment:
            ...
            if item.weight <= self.weight_capacity - self.current_weight:
...
def start_program():
    ...
    """
    print("Initialised 57 items including 25 containers.")
    print("")
